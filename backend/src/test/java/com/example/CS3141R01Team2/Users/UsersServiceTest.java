...
class UsersServiceTest {
    ...
    void testShowUsers() {
        ...
        List<Users> actualShowUsersResult = usersService.showUsers();
        assertSame(usersList, actualShowUsersResult);
    ...
    @Test
    void testShowUsers2() {
        when(usersRepository.findAllUsers()).thenThrow(new IllegalStateException());
