...
class RegistrationServiceTest {
    ...
    void testRegister() {
        ...
        when(usernameValidator.test((String) any())).thenReturn(true);
        ...
        verify(usernameValidator).test((String) any());
    }
    ...
    void testRegister2() {
        ...
        when(emailValidator.test((String) any())).thenReturn(true);
        doNothing().when(emailSender).send((String) any(), (String) any());
        when(usernameValidator.test((String) any())).thenThrow(new IllegalStateException());
    ...
    void testRegister4() {
        ...
        //       at com.example.CS3141R01Team2.Registration.RegistrationService.register(RegistrationService.java:28)
